...
CREATE TABLE `lesson` (
    ...
    `attachmentQuestion` VARCHAR(255) NULL,
    `rightAnswer` VARCHAR(255) NOT NULL,
    `attachment0` VARCHAR(255) NULL,
    `wrongAnswer1` VARCHAR(255) NOT NULL,
    `attachment1` VARCHAR(255) NULL,
    `wrongAnswer2` VARCHAR(255) NOT NULL,
    `attachment2` VARCHAR(255) NULL,
    `wrongAnswer3` VARCHAR(255) NOT NULL,
    `attachment3` VARCHAR(255) NULL,
    `createdAt` VARCHAR(30) NOT NULL,
    `updatedAt` VARCHAR(30) NULL,
    `deletedAt` VARCHAR(30) NULL,
...
CREATE TABLE `topic_progress` (
    ...
    `deletedAt` VARCHAR(30) NULL,
    `updatedAt` VARCHAR(30) NULL,
    `lastModifiedAt` VARCHAR(30) NULL,
